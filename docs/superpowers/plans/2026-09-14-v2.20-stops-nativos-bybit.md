...
Todas las tareas siguientes commitean en esta rama. El merge a main es la Task 6.
...
Expected: PASS, 24 tests (16 previos + 8 nuevos).
...
Expected: compila sin error; PASS, 30 tests.
...
Expected: compila; PASS, 30 tests.
...
Expected: compila; PASS, 35 tests.
...
```
Expected: PASS, 35 tests. Producción todavía corre v2.19 — sin cambios de comportamiento.
